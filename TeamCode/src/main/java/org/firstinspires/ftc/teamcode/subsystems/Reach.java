...
public class Reach {
    ...
    public Reach(HardwareMap hardwareMap) {
        ...
        reach_motor.setPIDFCoefficients(DcMotorEx.RunMode.RUN_USING_ENCODER, pidf_coef);

        reach_motor.setMotorEnable();//TODO test removing this
    }

    public void update(int target_position) {
        reach_motor.setTargetPosition(target_position);
    }
