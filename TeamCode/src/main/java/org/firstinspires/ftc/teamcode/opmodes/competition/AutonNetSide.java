...
public class AutonNetSide extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        Pose2d firstSpikeMark = new Pose2d(-34.5, -21, Math.toRadians(180));
        Pose2d secondSpikeMark = new Pose2d(-44.5, -19.5, Math.toRadians(180));
        Pose2d thirdSpikeMark = new Pose2d(-52.5, -19, Math.toRadians(175));
